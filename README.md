## नमस्ते (Namaste), I'm [Prem](https://www.linkedin.com/in/prem-rawat/)
...
💭 My personal mission is to build AI-based product that solve the impactful problem which help the people around the world in an eco-friendly way.
...
🎓 I'm certified [TensorFlow - Developer](https://www.coursera.org/account/accomplishments/professional-cert/NQHAR8NFL27W) from the [Coursera - DeepLearning.AI](https://www.coursera.org/), Deep Learning and Applied NLP from the [Swayam-NPTEL](https://swayam.gov.in/)
